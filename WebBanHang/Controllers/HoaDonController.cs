...
namespace WebBanHang.Controllers
{
    ...
    public class HoaDonController : ControllerBase
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine(HttpContext.Session.GetInt32("iduser") + " id user session ben checkout");
            System.Diagnostics.Debug.WriteLine(insert.MaKhachHang + " id user post lên checkout");
