...
namespace WebBanHang.Controllers
{
    ...
    public class KhachHangController : ControllerBase
    {
        ...
        public async Task<ActionResult<KhachHang>> GetCustomorDetail(int id)
        {
            ...
            if (id == HttpContext.Session.GetInt32("iduser")) { 
        ...
        public async Task<ActionResult> CustomorLogin(KhachHang userData)
        {
            ...
            if (userData != null && userData.TenDangNhap != null && userData.MatKhau != null)
            {
               ...
               //  System.Diagnostics.Debug.WriteLine(userToken + " -   uesfsd");
               // HttpContext.Session.SetString("token", userToken.ToString());

                if (userToken != null) 
                {
                    var user = _userservice.CheckAccPass(userData);
                    HttpContext.Session.SetInt32("iduser", user.Result.MaKhachHang);
                    System.Diagnostics.Debug.WriteLine( HttpContext.Session.GetInt32("iduser") + " id user");
