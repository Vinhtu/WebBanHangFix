...
namespace WebBanHang.Controllers
{
    ...
    public class BinhLuanController : ControllerBase
    {
        ...
        {   
            ...
            System.Diagnostics.Debug.WriteLine(HttpContext.Session.GetInt32("iduser") + " id user session ben binh luan");
            System.Diagnostics.Debug.WriteLine(insert.MaKhachHang + " id user post lên");

             if (insert.MaKhachHang == HttpContext.Session.GetInt32("iduser")) {  
                await _commetnservice.AddComment(insert);
                return Ok("Add Comment Success"); 
              }
     
            return Ok("Add Comment Failed!");
        }
